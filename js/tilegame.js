...
var Game = {
    ...
    tileSrcs : ["img/floor.png", "img/wall.png", "img/exit.png", "img/door.png", "img/key.png", "img/robin.png"],
    imgSrcs : ["img/hero.png"],
    tiles : [],
    offsetX : 22,
    offsetY : 10,
...
Game.initModel = function () {
    ...
    Game.hero = new Game.Hero(heroX, heroY);
